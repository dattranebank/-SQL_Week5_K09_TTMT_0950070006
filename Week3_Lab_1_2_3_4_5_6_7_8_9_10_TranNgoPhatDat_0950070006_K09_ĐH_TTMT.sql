...
/* Lab 9, câu 1: Tạo trigger kiểm soát việc nhập dữ liệu cho bảng nhập, 
...
Sau khi xuất thì solunog ở bảng Sanpham sẽ được cập nhật theo */

/* Lab 9, câu 3: Tạo trigger kiểm soát việc xóa phiế xuất, khi phiếu xuất xóa thì số lượng hàng 
trong bảng sanpham sẽ được cập nhật tăng lên */

/* Lab 9, câu 4: Tạo trigger cho việc cập nhật lại số lượng xuất trong bảng Xuat,
hãy kiểm tra xem số lượng xuất thayd 9ổi có nhỏ hơn soluong trong bảng sanpham hay không?
...
Hãy kiểm tra xem số bản ghi thay đổi >1 bản ghi hay không? Nếu thỏa mãn thì cho phép update
